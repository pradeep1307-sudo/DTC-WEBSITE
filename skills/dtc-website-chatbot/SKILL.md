...
description: Maintain and extend the Denver Tamil Church website chatbot in script.js, contact.html, and styles.css. Use when changing chatbot answers, website-page knowledge retrieval, floating chat UI, suggested prompts, unknown-question behavior, or the Connect intake and church-email handoff.
---
...
2. Inspect every public HTML page and `script.js` for current facts before changing answers.
...
- Chat implementation and curated knowledge: `script.js`, `initChurchChat`
- Static Contact-page shell: `contact.html`
- Shared generated shell: `script.js`, `initChurchChat`
